...
namespace HolisticWare.ToolbarSimple
{
	[Activity 
		(
			Label = "HolisticWere.Toolbar.TabLayout", 
			MainLauncher = true, 
			Icon = "@mipmap/icon",
	...
	public class ActivityLayout : AppCompatActivity
	{
		...
		protected override void OnCreate (Bundle savedInstanceState)
		{
			...
			var mViewPager = FindViewById<Android.Support.V4.View.ViewPager>(Resource.Id.viewpager);
			mViewPager.Adapter = new SamplePagerAdapter();
			var mSlidingTabLayout = FindViewById<SlidingTabLayout>(Resource.Id.sliding_tabs);
			mSlidingTabLayout.ViewPager = mViewPager;
